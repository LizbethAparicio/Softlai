...
function validaform3(){//consulta clientes
	...
	if (document.form3.buscar1.value.length==0 && document.form3.criterios.value.length=='Usuario'){
		alert(errorMessage);
...
function excel(){
	if(document.form3.criterios.value=='Usuario' && document.form3.buscar1.value.length==0){
...
function excelproduct(){
	...
	var msg=confirm("Esta seguro de generar el archivo de excel");
	if(msg){
		form3.action="excelproducto.php";
		form3.submit ( );	
	}
}
...
function word(){
	...
	var msg1=confirm("Esta seguro de generar el archivo de word");
	if(msg1){
...
function wordprove(){
	...
	var msg1=confirm("Esta seguro de generar el archivo de word");
	if(msg1){
		form3.action="wordprove.php";
		form3.submit ( );	
	}
}
function wordproduct(){
	if(document.form3.criterios.value=='Usuario' && document.form3.buscar1.value.length==0){
		alert("Inserte el texto a buscar")
		document.form3.buscar1.focus()
		return 0;
...
function pdf(){
	...
	var msg4=confirm("Esta seguro de generar el archivo de PDF");
	if(msg4){
		form3.action="pdf.php";
		form3.submit ( );	
	}
}
function pdfcarro(){
